...
doctor:
    @echo "Running diagnostics for ProvenCrypto.jl..."
...
help-me:
    @echo "=== ProvenCrypto.jl Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/ProvenCrypto.jl/issues/new"
    @echo ""
