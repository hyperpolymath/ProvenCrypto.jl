{
  description = "ProvenCrypto.jl - {project-description}";
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in
      {
        ...
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            echo "🚀 ProvenCrypto.jl development environment"
        ...
        packages.default = pkgs.stdenv.mkDerivation {
          ...
          buildPhase = ''
            ...
            # For Ada: gprbuild -P ProvenCrypto.jl.gpr -XMODE=release
          '';

          installPhase = ''
            mkdir -p $out/bin
            # *REMINDER: Add install commands*
            # cp target/release/ProvenCrypto.jl $out/bin/  # Rust
            # cp bin/ProvenCrypto.jl $out/bin/  # Ada
          '';
        ...
        apps.default = {
          type = "app";
          program = "${self.packages.${system}.default}/bin/ProvenCrypto.jl";
        };
        ...
        checks = {
          ...
          test = pkgs.runCommand "test-ProvenCrypto.jl" {
